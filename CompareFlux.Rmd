...
x<-(t(sapply(1:100,function(i){
  oot1 <- flux_function(mobility_data,fit1,FALSE,TRUE,NA)
  oot2 <- flux_function(mobility_data,fit2,FALSE,TRUE,NA)
...
CPCcmp_measureEm <- bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC Total',100))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC Under 18',100)))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC Education',100)))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC 18-30',100)))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC Employed',100)))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC 30-60',100)))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC NEET',100)))
...
CPCcmp_measureEm <- CPCcmp_measureEm %>% bind_rows(bind_cols(CPCpp(total_mobility_dat,
                 ...
                 'Census (E)','Next',
                 CDOmatflux),category=rep('BBC 60-100',100)))
