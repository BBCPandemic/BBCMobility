...
fit_S_CDOT <- stan(file = '../../../stan/CDORnegbin.stan', 
...
fit_W_CDOT <- stan(file = '../../../stan/CDORnegbin.stan', 
...
fit_NI_CDOT <- stan(file = '../../../stan/CDORnegbin.stan', 
...
fit_E_CDOT <- stan(file = '../../../stan/CDORnegbin.stan', 
