...
g2=ggplot(df,aes(x=N,y=p_move)) + geom_point() + xlab('Population Size') + ylab(expression(italic(p[BBC]))) + scale_x_log10() + ggtitle('B')

g3=ggplot(df,aes(x=A,y=p_move)) + geom_point() + xlab(expression('Area km'^"2")) + ylab(expression(italic(p[BBC]))) + scale_x_log10() + ggtitle('C')
