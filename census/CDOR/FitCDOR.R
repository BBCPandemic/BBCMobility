...
fitCDO_CS <- stan(file = '../../stan/CDORnegbin.stan',
...
fitCDO_CNI <- stan(file = '../../stan/CDORnegbin.stan',
...
fitCDO_CW <- stan(file = '../../stan/CDORnegbin.stan',
...
fitCDO_CE <- stan(file = '../../stan/CDORnegbin.stan',
