...
fitCDO_CSphi1 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
...
fitCDO_CNIphi1 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
...
fitCDO_CWphi1 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
...
fitCDO_CEphi1 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
...
fitCDO_CSphi2 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = scotland_census_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CNIphi2 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                      data = NIcensus_mobility_dat,
                      iter = 2000, chains = 4)
...
fitCDO_CWphi2 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Wcensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CEphi2 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Ecensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CSphi3 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = scotland_census_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CNIphi3 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                      data = NIcensus_mobility_dat,
                      iter = 2000, chains = 4)
...
fitCDO_CWphi3 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Wcensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CEphi3 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Ecensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CSphi4 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = scotland_census_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CNIphi4 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                      data = NIcensus_mobility_dat,
                      iter = 2000, chains = 4)
...
fitCDO_CWphi4 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Wcensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CEphi4 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Ecensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CSphi5 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = scotland_census_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CNIphi5 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                      data = NIcensus_mobility_dat,
                      iter = 2000, chains = 4)
...
fitCDO_CWphi5 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Wcensus_mobility_dat,
                     iter = 2000, chains = 4)
...
fitCDO_CEphi5 <- stan(file = '../../stan/CDORnegbin_fixphi.stan',
                     data = Ecensus_mobility_dat,
                     iter = 2000, chains = 4)
